...
const Item = () => {
  ...
  const addInCart = () => {
    ...
    dispatch(setItemInCart(itemToAdd));
  };
        ...
        <div className="max-w-3xl mx-auto bg-gray-400 rounded-lg shadow-lg p-6">
          <div className="flex flex-col md:flex-row">
            ...
            <div className="md:w-1/2 md:pl-8">
              ...
              <p className="text-gray-700 mb-4">Цена: {foodItem.price} KGS</p>
              <p className="text-gray-700 mb-4">{foodItem.description}</p>
              <button 
              onClick={() => addInCart()}
              className="py-2 px-4 bg-black text-[#FFD700] rounded hover:text-black hover:bg-[#FFD700] active:bg-[#F0E68C] disabled:opacity-50 mt-4">
                Добавить в заказ
              </button>
            </div>
          </div>
